...
public class SlimeyBoyPatrol : MonoBehaviour
{
    /// <summary>
    ...
    void Start()
    {
        ...
        else if (this.name == ("MediumSlimey1") || this.name == ("MediumSlimey2"))
        {
            this._vitesse = Random.Range(1.5f, 2.5f);
        }
        else
        {
            this._vitesse = Random.Range(2.5f, 3f);
        }
    }
